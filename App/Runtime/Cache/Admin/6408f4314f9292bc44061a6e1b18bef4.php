        ...
        <div class="col-md-9">
           <div class="margin-bottom-20">
            <div class="panel pgy-panel-sea margin-bottom-40">
	            ...
	            <form class="reg-page sky-form" id="form" method="POST" action="__URL__/editUsedcarHandle" >
	            		<input type="hidden" name="id" value="<?php echo ($car["id"]); ?>" />
	            		<input type="hidden" id="thumbnailName" name="thumbnailName" value="<?php echo ($car["image"]); ?>" />
	            		<div class="reg-header">
		                    <p><img id="thumbnail_img" src="Public/upload/<?php echo ($car["image"]); ?>" style="width:200px;height:150px"></p>
		                    <br>
		                </div>
						<section>
		                    <label class="input">
                        ...
                        <section>
		                    ...
		                    <label class="input">
		                        ...
		                        <input type="text" id="name" name="name" value="<?php echo ($car["name"]); ?>" placeholder="请输入名称">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="price" name="price" value="<?php echo ($car["price"]); ?>" placeholder="请输入价格">
		                    </label>
		                </section>
		                <section>
		                    <label class="label">详情(输入网址)</label>
		                    <label class="textarea textarea-resizable">
		                        <textarea id="content" name="content" rows="4" class="textArea" /><?php echo ($car["content"]); ?></textarea>
		                    </label>
		                </section>
		                <div class="row">
