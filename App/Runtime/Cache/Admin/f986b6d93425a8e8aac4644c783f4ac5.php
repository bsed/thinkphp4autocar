            ...
            <div class="panel pgy-panel-sea margin-bottom-40">
                <div class="panel-heading pgy-panel-heading">
                  <h3 class="panel-title" style="color:#fff">
                    <i class="fa fa-angle-double-right"></i>生成二维码 &nbsp;
                    <!--  
	            ...
	            <form class="reg-page sky-form" id="form" method="POST" action="__URL__/generateCode" >
                        <section>
		                    <label class="label">机房编号</label>
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="name" name="name" value="" placeholder="请输入一段字符">
		                    </label>
		                </section>
		                <div class="reg-header">
		                    <p><img id="thumbnail_img" src=""></p>
		                    <br>
		                </div>
		                <div class="row">
		                    ...
		                    <div class="col-md-6 col-xs-6 text-right">
		                        <button class="btn-u" type="submit" id="submitButton" onclick="submitForm()">生成二维码</button>
		                    </div>
		                </div>
		        </form>
            </div>
...
function submitForm(){
    ...
    function complete(d){
        if (d.error == ""){
        	$("#thumbnail_img").attr("src",d.qrcode);
        }else{
        	alert(d.error);
        	loading=0;
        }
