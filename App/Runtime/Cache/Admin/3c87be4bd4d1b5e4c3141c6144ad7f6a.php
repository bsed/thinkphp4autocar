        ...
        <div class="col-md-9">
           <div class="margin-bottom-20">
            <div class="panel pgy-panel-sea margin-bottom-40">
	            ...
	            <form class="reg-page sky-form" id="form" method="POST" action="__GROUP__/Wuzhouyuan/editNewsHandle" >
	            		<input type="hidden" name="newsId" value="<?php echo ($news["id"]); ?>" />
                        <section>
		                    <label class="label">标题</label>
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="title" name="title" value="<?php echo ($news["title"]); ?>" placeholder="请输入新闻名称">
		                    </label>
		                </section>
		                <section>
		                ...
		                <section>
		                    ...
		                    <label class="textarea textarea-resizable">
		                        <textarea rows="6" placeholder="请输入文章内容" id="content" name="content"><?php echo ($news["content"]); ?></textarea>
		                    </label>
		                </section>
		                <div class="row">
