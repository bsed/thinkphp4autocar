            ...
            <div class="panel pgy-panel-sea margin-bottom-40">
                <div class="panel-heading pgy-panel-heading">
                  <h3 class="panel-title" style="color:#fff">
                    <i class="fa fa-angle-double-right"></i>编辑座位 &nbsp;
                    <!--  
	            ...
	            <form class="reg-page sky-form" id="form" method="POST" action="__URL__/editSeatHandle" >
	            		<input type="hidden" name="id" value="<?php echo ($seat["id"]); ?>"/>
                        <section>
		                    <label class="label">编号</label>
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="number" name="number" value="<?php echo ($seat["number"]); ?>" placeholder="请输入编号">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="name" name="name" value="<?php echo ($seat["name"]); ?>" placeholder="请输入名称">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="lasttime" name="lasttime" value="<?php echo ($seat["rent_time"]); ?>" placeholder="请输入时间">
		                    </label>
		                </section>
