...
<div class="container content">
    <div class="row">
        <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
            <form class="reg-page sky-form" id="form" method="POST" action="__GROUP__/App/editApplicationHandle" novalidate="novalidate">
                ...
                <div class="reg-header">
                    <p><img id="thumbnail_img" src="__ROOT__/Public/djh/thumbnail/<?php echo ($appInfo["thumbnail_name"]); ?>" class="appicon"></p>
                    <br>
                </div>
				...
				<section>
                    ...
                    <a href="javascript:void(0);" id="uploader-screenshot" class="btn-u btn-u-xs app_edit_screenshot_upload_button" style="position: relative; overflow: hidden; direction: ltr;"><i class="fa fa-picture-o"></i>
                     	更换应用图标<input id="thumbnail" type="file" name="thumbnail" style="position: absolute; right: 0px; top: 0px; font-family: Arial; font-size: 118px; margin: 0px; padding: 0px; cursor: pointer; opacity: 0;" /></a>
                    </label>
                </section>
                <section>
                    ...
                    <label class="input">
                        ...
                        <input type="text" id="apkName" name="apkName" style="padding-left:400px;" value="<?php echo ($appInfo["downloadName"]); ?>" disabled="disabled" placeholder="上传apk获取地址">
                    </label>
                </section>
                <section>
                    <label class="input">
                        <a href="javascript:void(0);" id="uploader-screenshot" class="btn-u btn-u-xs app_edit_screenshot_upload_button" style="position: relative; overflow: hidden; direction: ltr;"><i class="fa fa-picture-o"></i> 
                        	更换apk<input id="apk" type="file" name="apk" style="position: absolute; right: 0px; top: 0px; font-family: Arial; font-size: 118px; margin: 0px; padding: 0px; cursor: pointer; opacity: 0;" /></a>
                    </label>
                </section>
                <section>
                    ...
                    <label class="input">
                        ...
                        <input type="text" id="name" name="name" value="<?php echo ($appInfo["name"]); ?>" placeholder="请输入应用名称">
                    </label>
                </section>
                ...
                <section>
                    ...
                    <label class="input">
                        ...
                        <input type="text" id="version" name="version" value="<?php echo ($appInfo["version"]); ?>" placeholder="请输入版本号">
                    </label>
                </section>
				...
				<section>
                    ...
                    <label class="select">
                        <select name="appFirstMenu" id="appFirstMenu" style="width:200px;margin-right:10px;float:left;clear:none">
                        	<option value="<?php echo ($category["id1"]); ?>"><?php echo ($category["name1"]); ?></option>
                         ...
                         <option value="<?php echo ($category["id2"]); ?>"><?php echo ($category["name2"]); ?></option>
                        </select>
                         <select name="appThirdMenu" id="appThirdMenu" style="width:200px;margin-right:10px;">
                         <option value="<?php echo ($category["id3"]); ?>"><?php echo ($category["name3"]); ?></option>
                        </select>
...
-->
                ...
                <section>
                    ...
                    <label class="textarea textarea-resizable">
                        <textarea rows="6" placeholder="请输入该版本的更新说明" id="updateDescription" name="updateDescription"><?php echo ($appInfo["update_description"]); ?></textarea>
                    </label>
                </section>
                ...
                <section>
                    ...
                    <label class="textarea textarea-resizable">
                        <textarea rows="6" placeholder="请输入软件介绍" id="description" name="description"><?php echo ($appInfo["introduction"]); ?></textarea>
                    </label>
                </section>
                            ...
                            <div class="col-md-12 col-sm-12" id="screenshotTableContainer">
								...
								<div class="table-responsive" style="border:none; overflow:auto;">
								    <table class="table">
								        <tbody>
									        <tr>
									        	<?php if(is_array($appInfo['screenshots'])): $i = 0; $__LIST__ = $appInfo['screenshots'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$screenshot): $mod = ($i % 2 );++$i;?><td id="td<?php echo ($i); ?>" class="text-center" width="20%" style="border:none;float:left">
														<div style="height:160px;">
														<img id="screenshot_image" src="__ROOT__/Public/djh/screenshot/<?php echo ($screenshot); ?>" class="app_edit_screenshot_img "></div>
										         		<a href="javascript:void(0);" class="app_edit_screenshot_delete_button" style="margin-top:10px;" onclick="delScreenshot(<?php echo ($i); ?>)">删除</a>
										        	</td>
										        	<input type="hidden" id="sn<?php echo ($i); ?>" name="screenshotName[]" value="<?php echo ($screenshot); ?>" /><?php endforeach; endif; else: echo "" ;endif; ?>
									    	</tr>
								    </tbody></table>
								</div>
								<!-- ------------------------------------------ -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xs-6 text-right">
                        <button class="btn-u" type="submit" id="submitButton" onclick="submitForm()">保存信息</button>
                    </div>
                </div>
                <input id="appId" type="hidden" name="appId" value="<?php echo ($appInfo["id"]); ?>"/>
                <input id="thumbnailName" type="hidden" name="thumbnailName" value="<?php echo ($appInfo["thumbnail_name"]); ?>"/>
                <input id="apkname" type="hidden" name="apkname" value="<?php echo ($appInfo["downloadName"]); ?>"/>
                <input id="apksize" type="hidden" name="apksize" value="<?php echo ($appInfo["size"]); ?>"/>
            </form>
        </div>
    </div>
</div><!--/container-->		
...
function submitForm(){
    ...
    function complete(d){
        if (d.error == ""){
        	alert("保存成功");
        	window.location.href="__GROUP__/App/applicationDetails/appKey/"  + $("#appId").val(); 
        }else{
        	alert(d.error);
        	loading=0;
        }
