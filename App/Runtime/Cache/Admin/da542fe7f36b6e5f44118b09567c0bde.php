            ...
            <div class="panel pgy-panel-sea margin-bottom-40">
	            ...
	            <form class="reg-page sky-form" id="form" method="POST" action="__URL__/addadHandle" >
		                ...
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="cpnum" name="cpnum" value="" readonly="readonly">
		                    </label>
		                </section>
		               <div class="reg-header">
		                    <p><img  src="http://freefood.qiniudn.com/<?php echo ($info["idcard1"]); ?>" style="width:300px;height:200px"></p>
		                    <br>
		                </div>
		                <div class="reg-header">
		                    <p><img  src="http://freefood.qiniudn.com/<?php echo ($info["idcard2"]); ?>" style="width:300px;height:200px"></p>
		                    <br>
		                </div>
		                <div class="reg-header">
		                    <p><img  src="http://freefood.qiniudn.com/<?php echo ($info["xscard1"]); ?>" style="width:300px;height:200px"></p>
		                    <br>
		                </div>
		                <div class="reg-header">
		                    <p><img  src="http://freefood.qiniudn.com/<?php echo ($info["xscard2"]); ?>" style="width:300px;height:200px"></p>
		                    <br>
		                </div>
		                <div class="reg-header">
		                    <p><img  src="http://freefood.qiniudn.com/<?php echo ($info["jscard1"]); ?>" style="width:300px;height:200px"></p>
		                    <br>
		                </div>
		                <div class="reg-header">
		                    <p><img  src="http://freefood.qiniudn.com/<?php echo ($info["jscard2"]); ?>" style="width:300px;height:200px"></p>
		                    <br>
		                </div>
