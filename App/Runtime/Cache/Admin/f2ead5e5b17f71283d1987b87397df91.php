                ...
                <table class="table table-striped table-hover text-center myapps my_history pgy-table">
                    <thead>
                        <tr class="pgy-warning">
                        	<th class="text-center" width="20%">手机号</th>
                    ...
                    <tbody>
                    	<?php if(is_array($user)): foreach($user as $key=>$user): ?><tr class="my_history_row text-center">
	                            ...
	                            <td><?php echo (time_tran($user["created_time"])); ?></td>
	                            <td>
	                                <a class="btn btn-info btn-xs" href="__URL__/userinfo/id/<?php echo ($user["id"]); ?>"><i class="fa fa-edit"></i> 查看用户信息</a>
	                                <a class="btn btn-info btn-xs" href="__URL__/message/phone/<?php echo ($user["username"]); ?>"><i class="fa fa-edit"></i> 选择</a>
	                            </td>
...
$('.btn-danger').each(function() {
	$(this).click(function() {
		...
		loading=1;
		var url = '__URL__/deleteUserHandle';
