            ...
            <div class="panel pgy-panel-sea margin-bottom-40">
                <div class="panel-heading pgy-panel-heading">
                  <h3 class="panel-title" style="color:#fff">
                    <i class="fa fa-angle-double-right"></i>报修回复列表 &nbsp;
                    <!--  
                ...
                <table class="table table-striped table-hover text-center myapps my_history pgy-table">
                    <thead>
                        <tr class="pgy-warning">
                            <th class="text-center" width="20%">回复人</th>
                            <th class="text-center" width="20%">内容</th>
                            <th class="text-center" width="20%">回复时间</th>
                            <th class="text-center" width="20%">
                            	<a class="btn btn-info btn-xs" href="__URL__/addRepairComment/id/<?php echo ($id); ?>"><i class="fa fa-edit"></i> 添加回复</a>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                    	<?php if(is_array($comment)): foreach($comment as $key=>$comment): ?><tr class="my_history_row text-center">
	                    		<?php if($comment['nickname']): ?><td><?php echo ($comment["nickname"]); ?></td>
	                            <?php else: ?>
	                            	<td>管理员</td><?php endif; ?>
	                            <td><?php echo ($comment["content"]); ?></td>
	                            <td><?php echo (time_tran($comment["created_time"])); ?></td>
	                            <td>
	                            </td>
