            ...
            <div class="panel pgy-panel-sea margin-bottom-40">
                <div class="panel-heading pgy-panel-heading">
                  <h3 class="panel-title" style="color:#fff">
                    <i class="fa fa-angle-double-right"></i>费用 &nbsp;
                    <!--  
	            ...
	            <form class="reg-page sky-form" id="form" method="POST" action="" >
	            	<section>
	                    <label class="label">房号</label>
	                    <label class="input">
	                        <i class="icon-append fa fa-pencil"></i>
	                        <input type="text" id="num" name="num" value="<?php echo ($cost["number"]); ?>" disabled="disabled">
	                    </label>
	                </section>
	                <section>
	                    ...
	                    <label class="input">
	                        <i class="icon-append fa fa-pencil"></i>
	                        <input type="text" id="date" name="date" value="<?php echo ($cost["date"]); ?>" disabled="disabled">
	                    </label>
	                </section>
                     <section>
	                    ...
	                    <label class="input">
	                        <i class="icon-append fa fa-pencil"></i>
	                        <input type="text" id="water" name="water" value="<?php echo ($cost["water"]); ?>" disabled="disabled">
	                    </label>
	                </section>
	                <section>
	                    ...
	                    <label class="input">
	                        <i class="icon-append fa fa-pencil"></i>
	                        <input type="text" id="electric" name="electric" value="<?php echo ($cost["electric"]); ?>" disabled="disabled">
	                    </label>
	                </section>
	                <section>
	                    ...
	                    <label class="input">
	                        <i class="icon-append fa fa-pencil"></i>
	                        <input type="text" id="property" name="property" value="<?php echo ($cost["property"]); ?>" disabled="disabled">
	                    </label>
	                </section>
	                <section>
	                    ...
	                    <label class="input">
	                        <i class="icon-append fa fa-pencil"></i>
	                        <input type="text" id="heating" name="heating" value="<?php echo ($cost["heating"]); ?>" disabled="disabled">
	                    </label>
	                </section>
	                <section>
	                    ...
	                    <label class="input">
	                        <i class="icon-append fa fa-pencil"></i>
	                        <input type="text" id="repair" name="repair" value="<?php echo ($cost["repair"]); ?>" disabled="disabled">
	                    </label>
	                </section>
	                <div class="row">
