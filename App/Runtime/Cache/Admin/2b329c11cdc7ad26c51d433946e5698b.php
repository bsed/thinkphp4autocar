                ...
                <table class="table table-striped table-hover text-center myapps my_history pgy-table">
                    <thead>
                        <tr class="pgy-warning">
                            ...
                            <th class="text-center" width="20%">姓名</th>
                            <th class="text-center" width="20%">使用时长</th>
                            <th class="text-center" width="20%">最近登录</th>
                            <th class="text-center" width="20%">编辑</th>
                        </tr>
                    </thead>
                    <tbody>
                    	<?php if(is_array($user)): foreach($user as $key=>$user): ?><tr class="my_history_row text-center">
	                            <td><?php echo ($user["username"]); ?></td>
	                            <td><?php echo ($user["nickname"]); ?></td>
	                            <td><?php echo (time_using($user["created_time"])); ?></td>
	                            <td><?php echo (time_tran($user["last_modified_time"])); ?></td>
	                            <td>
	                                <a class="btn btn-info btn-xs" href="__URL__/editUser/id/<?php echo ($user["id"]); ?>"><i class="fa fa-edit"></i> 编辑</a>
	                                <a class="btn btn-danger btn-xs" onclick="javascript:void(0)" href="javascript:void(0);" id="<?php echo ($user["id"]); ?>"><i class="fa fa-trash-o"></i> 删除</a>
	                            </td>
