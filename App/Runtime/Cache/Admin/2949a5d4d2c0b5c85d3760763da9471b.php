            ...
            <div class="panel pgy-panel-sea margin-bottom-40">
                <div class="panel-heading pgy-panel-heading">
                  <h3 class="panel-title" style="color:#fff">
                    <i class="fa fa-angle-double-right"></i>编辑用户&nbsp;
                    <!--  
	            ...
	            <form class="reg-page sky-form" id="form" method="POST" action="__URL__/editUserHandle" >
                        ...
                        <section>
		                    ...
		                    <label class="input">
		                        ...
		                        <input type="text" id="username" name="username" value="<?php echo ($user["username"]); ?>" style="background-color:#eee;color:#666;" placeholder="请输入用户名" disabled="disabled">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="password" id="pwd" name="pwd" value="" placeholder="不修改密码可不填">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="name" name="name" value="<?php echo ($user["nickname"]); ?>" style="background-color:#eee;color:#666;" disabled="disabled">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="gender" name="gender" value="<?php echo ($user["gender"]); ?>" style="background-color:#eee;color:#666;" disabled="disabled">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="age" name="age" value="<?php echo ($user["age"]); ?>" style="background-color:#eee;color:#666;" disabled="disabled">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="role" name="role" value="<?php echo ($user["role"]); ?>" style="background-color:#eee;color:#666;" disabled="disabled">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="academy" name="academy" value="<?php echo ($user["academy"]); ?>" style="background-color:#eee;color:#666;" disabled="disabled">
		                    </label>
		                </section>
		                <?php if($user['role'] == '学生'): ?><section id="se-specialty">
			                    <label class="label">专业</label>
			                    <label class="input">
			                        <i class="icon-append fa fa-pencil"></i>
			                        <input type="text" id="specialty" name="specialty" value="<?php echo ($user["specialty"]); ?>" style="background-color:#eee;color:#666;" disabled="disabled">
			                    </label>
			                </section><?php endif; ?>
		                <div class="row">
