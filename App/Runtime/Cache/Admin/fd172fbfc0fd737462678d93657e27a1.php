        ...
        <div class="col-md-9">
           <div class="margin-bottom-20">
            <div class="panel pgy-panel-sea margin-bottom-40">
	            ...
	            <form class="reg-page sky-form" id="form" method="POST" action="__GROUP__/Wuzhouyuan/editJobsHandle" >
	            	<input type="hidden" name="jobId" value="<?php echo ($job["id"]); ?>" />
                    <section>
	                    <label class="label">标题</label>
	                    <label class="input">
	                        <i class="icon-append fa fa-pencil"></i>
	                        <input type="text" id="title" name="title" value="<?php echo ($job["title"]); ?>" placeholder="请输入兼职名称">
	                    </label>
	                </section>
	                <section>
	                    <label class="label">内容</label>
	                    <label class="textarea textarea-resizable">
	                        <textarea rows="6" placeholder="请输入兼职内容" id="content" name="content"><?php echo ($job["content"]); ?></textarea>
	                    </label>
	                </section>
	                <div class="row">
