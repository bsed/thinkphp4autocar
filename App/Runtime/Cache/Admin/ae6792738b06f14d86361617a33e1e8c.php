            ...
            <div class="panel pgy-panel-sea margin-bottom-40">
                <div class="panel-heading pgy-panel-heading">
                  <h3 class="panel-title" style="color:#fff">
                    <i class="fa fa-angle-double-right"></i>编辑设备 &nbsp;
                    <!--  
	            ...
	            <form class="reg-page sky-form" id="form" method="POST" action="__URL__/eidtEquipmentHandle" >
	            		<input type="hidden" name="id" value="<?php echo ($equipment["id"]); ?>" />
                        <section>
		                    <label class="label">名称</label>
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="name" name="name" value="<?php echo ($equipment["name"]); ?>" placeholder="请输入名称">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="attribute1" name="attribute1" value="<?php echo ($equipment["attribute1"]); ?>" placeholder="请输入属性1">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="attribute2" name="attribute2" value="<?php echo ($equipment["attribute2"]); ?>" placeholder="请输入属性2">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="attribute3" name="attribute3" value="<?php echo ($equipment["attribute3"]); ?>" placeholder="请输入属性3">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="select">
		                        <select name="roomId" id="roomId" >
		                        	<option value="<?php echo ($equipment["roomId"]); ?>"><?php echo ($equipment["rname"]); ?></option>
