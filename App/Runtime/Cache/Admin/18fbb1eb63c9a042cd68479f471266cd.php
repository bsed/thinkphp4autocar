           ...
           <div class="margin-bottom-20">
            <div class="panel pgy-panel-sea margin-bottom-40">
	            ...
	            <form class="reg-page sky-form" id="form" method="POST" action="__URL__/addadHandle" >
	            		<a class="btn btn-info btn-xs" href="__URL__/message/phone/<?php echo ($info1["username"]); ?>"><i class="fa fa-edit"></i> 选择该用户</a>
	            		<hr>
	            		<section>
		                    <label class="label">手机号</label>
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="phone" name="phone" value="<?php echo ($info["phone"]); ?>" readonly="readonly">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="cpnum" name="cpnum" value="<?php echo ($info["cpnum"]); ?>" readonly="readonly">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="djdate" name="djdate" value="<?php echo ($info1["dengji_date"]); ?>" readonly="readonly">
		                    </label>
		                </section>
		                 <section>
		                    <label class="label">机动车登记日期</label>
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="lqdate" name="lqdate" value="<?php echo ($info1["zhengjian_date"]); ?>" readonly="readonly">
		                    </label>
		                </section>
		               <div class="reg-header">
		                    <p><img  src="http://freefood.qiniudn.com/<?php echo ($info["idcard1"]); ?>" style="width:400px;height:280px"></p>
		                    <br>
		                </div>
		                <div class="reg-header">
		                    <p><img  src="http://freefood.qiniudn.com/<?php echo ($info["idcard2"]); ?>" style="width:400px;height:280px"></p>
		                    <br>
		                </div>
		                <div class="reg-header">
		                    <p><img  src="http://freefood.qiniudn.com/<?php echo ($info["xscard1"]); ?>" style="width:400px;height:280px"></p>
		                    <br>
		                </div>
		                <div class="reg-header">
		                    <p><img  src="http://freefood.qiniudn.com/<?php echo ($info["xscard2"]); ?>" style="width:400px;height:280px"></p>
		                    <br>
		                </div>
		                <div class="reg-header">
		                    <p><img  src="http://freefood.qiniudn.com/<?php echo ($info["jscard1"]); ?>" style="width:400px;height:280px"></p>
		                    <br>
		                </div>
		                <div class="reg-header">
		                    <p><img  src="http://freefood.qiniudn.com/<?php echo ($info["jscard2"]); ?>" style="width:400px;height:280px"></p>
		                    <br>
		                </div>
