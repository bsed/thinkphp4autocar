            ...
            <div class="panel pgy-panel-sea margin-bottom-40">
                <div class="panel-heading pgy-panel-heading">
                  <h3 class="panel-title" style="color:#fff">
                    <i class="fa fa-angle-double-right"></i>投诉列表 &nbsp;
                    <!--  
                ...
                <table class="table table-striped table-hover text-center myapps my_history pgy-table">
                    <thead>
                        <tr class="pgy-warning">
                            <th class="text-center" width="20%">投诉人</th>
                            <th class="text-center" width="20%">投诉内容</th>
                            <th class="text-center" width="20%">投诉时间</th>
                    ...
                    <tbody>
                    	<?php if(is_array($repair)): foreach($repair as $key=>$repair): ?><tr class="my_history_row text-center">
	                            ...
	                            <td>	
	                            	<a class="btn btn-info btn-xs" href="__URL__/complaintComment/id/<?php echo ($repair["id"]); ?>"><i class="fa fa-edit"></i> 查看</a>
...
$('.btn-danger').each(function() {
	$(this).click(function() {
		...
		loading=1;
		var url = '__URL__/deleteComplaint';
		$.post(url, params, function(d){
			if(d.error == ""){
				alert("删除成功");
	        	window.location.href="__URL__/complaint";
			}else{
				alert(d.error);
			}
		}, 'json');
