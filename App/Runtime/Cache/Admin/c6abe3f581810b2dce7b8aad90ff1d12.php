        ...
        <div class="col-md-9">
           <div class="margin-bottom-20">
            <div class="panel pgy-panel-sea margin-bottom-40">
	            ...
	            <form class="reg-page sky-form" id="form" method="POST" action="__GROUP__/Category/editCategoryHandle" >
                        <input type="hidden" name="id" value="<?php echo ($category["id"]); ?>" />
                        <section>
		                    <label class="label">名称</label>
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="name" name="name" value="<?php echo ($category["name"]); ?>" placeholder="请输入分类名称">
		                    </label>
		                </section>
		                <!--  
		                <section>
		                    ...
		                    <label class="select">
		                        <select name="applevel" id="applevel" >
									<option value="<?php echo ($category["level"]); ?>"><?php echo ($category["level"]); ?></option>
		                        </select>
		                    </label>
		                </section>
		                ...
		                <div class="row">
		                    ...
		                    <div class="col-md-6 col-xs-6 text-right">
		                        <button class="btn-u" type="submit" id="submitButton" onclick="submitForm()">保存分类</button>
		                    </div>
		                </div>
		        </form>
            </div>
