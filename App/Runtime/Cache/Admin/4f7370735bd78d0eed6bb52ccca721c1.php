            ...
            <div class="panel pgy-panel-sea margin-bottom-40">
                <div class="panel-heading pgy-panel-heading">
                  <h3 class="panel-title" style="color:#fff">
                    <i class="fa fa-angle-double-right"></i>审车列表 &nbsp;
                   </h3>
                </div>
                <table class="table table-striped table-hover text-center myapps my_history pgy-table">
                    <thead>
                        <tr class="pgy-warning">
                            ...
                            <th class="text-center" width="20%">审车时间</th>
                    ...
                    <tbody>
                    	<?php if(is_array($list)): foreach($list as $key=>$list): ?><tr class="my_history_row text-center">
	                            ...
	                            <td><?php echo ($list["scdate"]); ?></td>
	                            <td><?php echo (time_tran($list["created_time"])); ?></td>
	                            <td>
	                                <a class="btn btn-info btn-xs" href="__GROUP__/User/userinfo/id/<?php echo ($list["user_id"]); ?>"><i class="fa fa-edit"></i>查看用户信息</a>
	                            </td>
