...
<html lang="en"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="http://www.pgyer.com/static/lightbox/css/lightbox.css" rel="stylesheet">
...
-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xs-6 text-right">
                        <input type="hidden" name="key" id="key" value="ac7282c6c2f4c6cc7c7b7312ef976282">
                        <input type="hidden" name="identifier" id="identifier" value="com.feedingme">
