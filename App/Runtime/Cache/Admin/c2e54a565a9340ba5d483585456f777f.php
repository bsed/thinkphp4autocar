            ...
            <div class="panel pgy-panel-sea margin-bottom-40">
                <div class="panel-heading pgy-panel-heading">
                  <h3 class="panel-title" style="color:#fff">
                    <i class="fa fa-angle-double-right"></i>添加住户 &nbsp;
                    <!--  
	            ...
	            <form class="reg-page sky-form" id="form" method="POST" action="__URL__/addResidentHandle" >
	            		<section>
		                ...
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="gender" name="gender" value="" placeholder="请输入性别">
		                    </label>
		                </section>
		                <section>
		                    <label class="label">选择房产</label>
		                    <label class="select">
