                ...
                <table class="table table-striped table-hover text-center myapps my_history pgy-table">
                    <thead>
                        <tr class="pgy-warning">
                            ...
                            <th class="text-center" width="20%">车牌号</th>
                            <th class="text-center" width="20%">创建时间</th>
                            <th class="text-center" width="20%">查看位置</th>
                        </tr>
                    </thead>
                    <tbody>
                    	<?php if(is_array($list)): foreach($list as $key=>$list): ?><tr class="my_history_row text-center">
	                            ...
	                            <td>
	                                <a class="btn btn-info btn-xs" href="#"><i class="fa fa-edit"></i> 查看位置</a>
	                            </td>
