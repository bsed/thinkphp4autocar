            ...
            <div class="panel pgy-panel-sea margin-bottom-40">
                <div class="panel-heading pgy-panel-heading">
                  <h3 class="panel-title" style="color:#fff">
                    <i class="fa fa-angle-double-right"></i>添加座位 &nbsp;
                    <!--  
	            ...
	            <form class="reg-page sky-form" id="form" method="POST" action="__URL__/addSeatHandle" >
	            		<section>
		                    <label class="label">建筑编号</label>
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="jz_number" name="jz_number" value="" placeholder="请输入编号">
		                    </label>
		                </section>
		                <section>
		                    <label class="label">楼层编号</label>
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="lc_number" name="lc_number" value="" placeholder="请输入编号">
		                    </label>
		                </section>
		                <section>
		                    <label class="label">房间编号</label>
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="fj_number" name="fj_number" value="" placeholder="请输入编号">
		                    </label>
		                </section>
                        <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="number" name="number" value="" placeholder="请输入编号">
		                    </label>
		                </section>
		                <section>
		                ...
		                <section>
		                    <label class="label">有效时间（秒）</label>
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="lasttime" name="lasttime" value="30" placeholder="请输入时间">
		                    </label>
		                </section>
		                <div class="row">
