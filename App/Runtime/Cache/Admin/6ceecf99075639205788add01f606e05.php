            ...
            <div class="panel pgy-panel-sea margin-bottom-40">
	            ...
	            <form class="reg-page sky-form" id="form" method="POST" action="__URL__/addGoodsHandle" >
		                ...
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="scDate" name="scDate" class="datepicker" value="" placeholder="请输入生产时间">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="jhDate" name="jhDate" class="datepicker" value="" placeholder="请输入进货时间">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="saledNum" name="saledNum" value="" placeholder="请输入销售量">
		                    </label>
		                </section>
		                <section>
		                    ...
		                    <label class="input">
		                        <i class="icon-append fa fa-pencil"></i>
		                        <input type="text" id="surplusNum" name="surplusNum" value="" placeholder="请输入库存">
		                    </label>
		                </section>
		                <section>
